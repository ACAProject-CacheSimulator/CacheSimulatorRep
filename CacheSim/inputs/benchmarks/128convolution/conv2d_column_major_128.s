...
row_loop:
    ...
    addiu $14, $14, 512     # move to next row in input
    addiu $15, $15, 504     # move to next row in output
    addiu $12, $12, -1      # row counter--
    bne   $12, $0, row_loop # continue current column

    addiu $10, $10, 4       # move input pointer to next column
    addiu $11, $11, 4       # move output pointer to next column
    addiu $13, $13, -1      # column counter--
    bne   $13, $0, col_loop # continue next column
